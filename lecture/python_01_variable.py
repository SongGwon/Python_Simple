...
# 4) 논리형(boolean): True, False 대문자 필수
...
# 1.snake_case: 소문자만 사용, 합성어는 _만 사용
...
# 9.동적 출력
print("="*200)
student_num = 20233111
student_name = "frank"
# 출력 예: "조선대학교 20233111, frank 입니다."
print("조선대학교 20233111, frank 입니다.") #하드코딩  지양
# 1. format() - Old
