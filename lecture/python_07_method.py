...
# ex) 회사원 -> 매일 아침마다 보고서 작정(15줄 코드 작성)
...
#  4.return: 함수 종료 의미
#  5.return 반환값: 함수종료+호출문으로 반환값 전달(tupel)
...
#def test(a, b, c=3):         # O
#def test1(a, b=2, c=3):      # O
#def test2(a=1, b=2, c=3):    # O

#def test2(a=1, b, c):        # X
#def test2(a, b=2, c):        # X
#def test2(a=1, b=2, c):      # X
