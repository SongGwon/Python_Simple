...
# id = "          CHolong01    "
# id.lower()  "     cholong01  "
print(id.lower().strip())  #"cholong01"    '.' -> 참조연산자
...
print(str.rfind("World")) # 단어 첫 글자 인덱스 (뒤부터)
